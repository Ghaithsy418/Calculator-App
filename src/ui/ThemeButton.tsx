    ...
    <div className="flex items-end gap-5 tracking-wide">
      ...
      <div className="flex w-14 flex-col">
        ...
        <div className="relative h-5 w-full rounded-full bg-blue-600">
          <div
            onClick={handleClick}
            className={`absolute top-[3px] cursor-pointer transition-all duration-300 ${theme === 1 ? "translate-x-[3px]" : theme === 2 ? "translate-x-[21px]" : "translate-x-[39px]"} h-3.5 w-3.5 rounded-full bg-red-500`}
          ></div>
        </div>
      </div>
    </div>
